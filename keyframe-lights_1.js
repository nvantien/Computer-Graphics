...
LightsApp.prototype.createObjects = function()
{
	...
	var url = 'https://raw.githubusercontent.com/tparisi/WebGLBook/master/models/leeperrysmith/LeePerrySmith.js';
...
LightsApp.prototype.handleLoaded = function(geometry)
{
	if (geometry)
	{
		...
		var material = 	new THREE.MeshPhongMaterial(
				{ 	map : THREE.ImageUtils.loadTexture( "https://raw.githubusercontent.com/tparisi/WebGLBook/master/models/leeperrysmith/Map-COL.jpg" ), 
					ambient: 0xFFFFFF
				}
				);
